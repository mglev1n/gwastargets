...
#' (with PDF export targets for fast report rendering), and MR-MEGA MDS. Validates `trait_type`, `n_col`, and `manifest_df` before
...
#'   Default `"Data"`.
#' @param manhattan_width Width in inches for Manhattan plot PDF export.
#'   Default `16`.
#' @param manhattan_height Height in inches for Manhattan plot PDF export.
#'   Default `6`.
#'
